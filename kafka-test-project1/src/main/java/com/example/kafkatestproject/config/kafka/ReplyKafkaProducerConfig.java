...
//    }
    ...
    public ReplyingKafkaTemplate<String, String, String> replyKafkaTemplate(@Qualifier("producerFactory") ProducerFactory<String, String> pf,
                                                                            @Qualifier("repliesContainer") ConcurrentMessageListenerContainer<String, String> repliesContainer) {
        ReplyingKafkaTemplate replyingKafkaTemplate = new ReplyingKafkaTemplate<>(pf, repliesContainer);
